...
tableToPublish = [ 'intent','number','whichCommands', 'colour', 'howFast', 'confidence', 'direction', 'whichFunction', 'text', 'Manually']
fileNumber = 1
...
if __name__ == "__main__":
    ...
    rospy.Subscriber("recorder", String, recorderResponse)
    rospy.spin()
